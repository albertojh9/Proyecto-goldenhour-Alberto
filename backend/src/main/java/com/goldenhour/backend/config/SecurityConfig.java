...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // Por defecto, requerir autenticación para el resto
                .anyRequest().authenticated()
            )
            // Permitir frames para la consola de H2
            .headers(headers -> headers.frameOptions(HeadersConfigurer.FrameOptionsConfig::disable))
            // Agregar nuestro filtro de seguridad JWT antes del de usuario y password estándar
    ...
    public org.springframework.web.cors.CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(java.util.Arrays.asList("http://localhost:4200", "http://localhost:8100", "http://localhost:8080"));
